...
const { getAugustToolDefinitions } = require('./august-tools');
const { getCoworkToolDefinitions } = require('./cowork-tools');
const { getMcpServerStatus } = require('./mcp-client');
const { getPlugins } = require('./plugins');

const HOST_FILES_HOST_PATH = 'C:\\Users\\rober\\LocalFolders\\DockerContainer\\claudish-proxy\\host_files';
...
function getCompatibilityStatus() {
    ...
    return {
        ...
        claudeDesktopPluginRestriction: {
            ...
            message: 'Claude Desktop third-party/organization plugin marketplace restrictions cannot be unlocked by the proxy. Local proxy plugins are the compatibility path: imported skills and MCP servers are injected through Claudish Proxy instead.'
        },

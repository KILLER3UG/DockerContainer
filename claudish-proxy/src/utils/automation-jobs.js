...
const { appendRecentEvent, readAugustCoreMemory, writeAugustCoreMemory } = require('./core-memory');

const AUTOMATION_FILE = path.join(__dirname, '..', 'august_automation_jobs.json');
const AUTOMATION_LOCK_FILE = path.join(__dirname, '..', 'august_automation_jobs.tick.lock');
